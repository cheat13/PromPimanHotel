...
import { GuestRegist,GuestRegister } from '../../models/GuestRegist';

@IonicPage()
@Component({
  selector: 'page-guest-registration',
...
export class GuestRegistrationPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad GuestRegistrationPage');
    this.GuestRegists = GuestRegister;
  }

  calcuratePax(){
    let calPax = new GuestRegist();
    calPax.pax
  }
